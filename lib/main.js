 ...
 * Extractor Object.
 */
function Extractor(ac, breakOnMatch) {
    EventEmitter.call(this);
    var self = this;
    self.matchers = [];
    self.vars = ac || {};
    self.watchers = [];
    self.breakOnMatch = (typeof breakOnMatch !== 'undefined') ? breakOnMatch : true;
...
/** exports */
module.exports = function (ac, breakOnMatch) {
    return new Extractor(ac, breakOnMatch);
};
